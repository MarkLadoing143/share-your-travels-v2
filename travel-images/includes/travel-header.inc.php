      ...
      <div class="container">
         <div class="pull-right">
            <ul class="list-inline">
              <li><a href="browse-cart.php"><span class="glyphicon glyphicon-shopping-cart"></span>View Print Cart</a></li>
           ...
           <div class="navbar-collapse collapse">
             ...
             <ul class="nav navbar-nav">
               ...
               <li class="dropdown">
                 ...
                 <input type="text" class="form-control" placeholder="Search for Images" name="search">
                 </div>
